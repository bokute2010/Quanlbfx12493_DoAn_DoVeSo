...
const SouthLotterySchema = new Schema({
    provinceId: {
...
SouthLotterySchema.methods.addLottery = function (lottery) {
...
module.exports = mongoose.model('SouthLottery', SouthLotterySchema);